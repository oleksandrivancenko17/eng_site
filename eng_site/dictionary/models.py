...
class Word(models.Model):
    ...
    english_word = models.CharField(max_length=300, db_index=True, verbose_name="Слово англійською")
    translation = models.CharField(max_length=300, db_index=True, verbose_name='Переклад слова')
